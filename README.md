...
frame is α = 0.811124 of the step, successive residuals fall by exactly `e^(−dt/τ)` = 0.188876, and
a cooled photon detector settles in one frame. The interval is **elapsed scene time**, not the
frame rate: a 10 ms membrane settles completely across ADR 0074's six-second time-lapse, where
driving it at 1/60 s would leave 19 % of a scene six seconds old in the picture. No golden moved —
