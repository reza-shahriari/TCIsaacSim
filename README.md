...
difference is the lesson. Propellers are omitted: a solid 28-inch disc is 33 px at this range and
hides the motors, and the smeared annulus a real prop makes needs the motion path (M10.1b).
