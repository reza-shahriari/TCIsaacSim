...
in physical units (M10.9a-ii, M10.19, M10.10a). There is no sky dome and no ground plane: a ray
that hits nothing takes `T_sky(θ)` at its own elevation or `T_ground` below the horizon
