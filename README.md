...
| `noise` | 🟡 partial | T1 | Counter-based per-pixel hash RNG (bit-exact on CPU and, by contract, GPU) + PCG64 for Poisson (ADR 0022); 3-D synthesiser, NETD anchoring and the noise stage pending |
