...
| `pipeline` | 🟡 partial | T1 | Engine-free NumPy oracle (ADR 0018): stage 1 emission-only band radiance, stage 3 optics (`apply_optics`); detector/ISP stages and `run_frame` pending |
