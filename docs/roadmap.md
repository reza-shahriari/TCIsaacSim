...
### Start here → `RP.6` · Repair

> Backfill commit hashes into the shipped ledger from `git log`. Revision 3 prescribed `done YYYY-MM-DD <hash>` and **zero of its 162 done rows carried one**, M0.1 included — the row it cited as the example.

`RP.6` is phase 0, size M, and unblocks 1 other step(s).

#### Then, in order — 103 open steps

| # | step | lane | phase | size | unblocks | waiting on |
|---|---|---|---|---|---|---|
| 1 | **`RP.6`** | RP | 0 | M | 1 | ready |
| 2 | **`IG.8`** | IG | 0 | S | — | ready |
| 3 | **`PT.4`** | PT | 0 | S | — | ready |
| 4 | **`RP.8`** | RP | 0 | S | — | ready |
| 5 | **`RP.9`** | RP | 0 | S | — | ready |
| 6 | **`RP.2`** | RP | 0 | M | — | ready |
| 7 | **`RP.5`** | RP | 0 | M | — | ready |
| 8 | **`PT.2`** | PT | A | M | 7 | ready |
| 9 | **`PT.1`** | PT | A | M | 4 | ready |
| 10 | **`PT.5`** | PT | A | M | 4 | `PT.2` |
| 11 | **`AT.1`** | AT | A | L | 4 | ready |
| 12 | **`GT.1`** | GT | A | M | 2 | ready |
| 13 | **`IG.13`** | IG | A | M | 2 | ready |
| 14 | **`SC.1`** | SC | A | M | 2 | ready |
| 15 | **`AT.2`** | AT | A | S | 1 | ready |
