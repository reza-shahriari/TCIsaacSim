...
### Start here → `RP.7` · Repair

> `docs/spec-issues.md`: one of sixty rows is Resolved and line 20 still says "everything else is open" while fourteen-plus issues have shipped ADRs. **Reopen S13:** glass `mwir: 0.02` was authored in `412f019`, six commits before `data/nk/glass.csv` existed (`1a0f13c`).

`RP.7` is phase 0, size M, and unblocks 2 other step(s).

#### Then, in order — 105 open steps

| # | step | lane | phase | size | unblocks | waiting on |
|---|---|---|---|---|---|---|
| 1 | **`RP.7`** | RP | 0 | M | 2 | ready |
| 2 | **`IG.5`** | IG | 0 | S | 1 | ready |
| 3 | **`RP.6`** | RP | 0 | M | 1 | ready |
| 4 | **`IG.8`** | IG | 0 | S | — | ready |
| 5 | **`PT.4`** | PT | 0 | S | — | ready |
| 6 | **`RP.8`** | RP | 0 | S | — | ready |
| 7 | **`RP.9`** | RP | 0 | S | — | ready |
| 8 | **`RP.2`** | RP | 0 | M | — | ready |
| 9 | **`RP.5`** | RP | 0 | M | — | ready |
| 10 | **`PT.2`** | PT | A | M | 7 | ready |
| 11 | **`PT.1`** | PT | A | M | 4 | ready |
| 12 | **`PT.5`** | PT | A | M | 4 | `PT.2` |
| 13 | **`AT.1`** | AT | A | L | 4 | ready |
| 14 | **`GT.1`** | GT | A | M | 2 | ready |
| 15 | **`IG.13`** | IG | A | M | 2 | ready |
