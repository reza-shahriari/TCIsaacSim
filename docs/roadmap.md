...
### Start here → `RP.2` · Repair

> Restructure `CHANGELOG.md`. One `[Unreleased]` section of 3,025 lines and 270 KB with 20+ repeated Added/Changed/Fixed headings is a single merge hotspot for three sessions. Split into dated sub-sections with one heading set each.

`RP.2` is phase 0, size M, and unblocks 0 other step(s).

#### Then, in order — 98 open steps

| # | step | lane | phase | size | unblocks | waiting on |
|---|---|---|---|---|---|---|
| 1 | **`RP.2`** | RP | 0 | M | — | ready |
| 2 | **`RP.5`** | RP | 0 | M | — | ready |
| 3 | **`PT.2`** | PT | A | M | 7 | ready |
| 4 | **`PT.1`** | PT | A | M | 4 | ready |
| 5 | **`PT.5`** | PT | A | M | 4 | `PT.2` |
| 6 | **`AT.1`** | AT | A | L | 4 | ready |
| 7 | **`GT.1`** | GT | A | M | 2 | ready |
| 8 | **`IG.13`** | IG | A | M | 2 | ready |
| 9 | **`SC.1`** | SC | A | M | 2 | ready |
| 10 | **`AT.2`** | AT | A | S | 1 | ready |
| 11 | **`SC.3`** | SC | A | M | 1 | ready |
| 12 | **`AT.3`** | AT | A | S | — | `AT.2` |
| 13 | **`AT.5`** | AT | A | S | — | ready |
| 14 | **`IG.6`** | IG | A | S | — | ready |
| 15 | **`SC.2`** | SC | A | S | — | `SC.1` |

…and 83 more — `python scripts/next_step.py --queue 40`.
