...
### Start here → `RP.8` · Repair

> CLAUDE.md factual corrections. `docs/maps/` is advertised as navigation aids; it is 729 KB, one commit ever, and its own README calls it frozen 2026-09-10 snapshots that are "not maintained". `spg/` is advertised as holding .cu/.cu.lua/.usda and holds one README.

`RP.8` is phase 0, size S, and unblocks 0 other step(s).
...
| 3 | **`RP.2`** | RP | 0 | M | — | ready |
| 4 | **`RP.5`** | RP | 0 | M | — | ready |
| 5 | **`PT.2`** | PT | A | M | 7 | ready |
| 6 | **`PT.1`** | PT | A | M | 4 | ready |
| 7 | **`PT.5`** | PT | A | M | 4 | `PT.2` |
| 8 | **`AT.1`** | AT | A | L | 4 | ready |
| 9 | **`GT.1`** | GT | A | M | 2 | ready |
| 10 | **`IG.13`** | IG | A | M | 2 | ready |
| 11 | **`SC.1`** | SC | A | M | 2 | ready |
| 12 | **`AT.2`** | AT | A | S | 1 | ready |
| 13 | **`SC.3`** | SC | A | M | 1 | ready |
| 14 | **`AT.3`** | AT | A | S | — | `AT.2` |
| 15 | **`AT.5`** | AT | A | S | — | ready |
