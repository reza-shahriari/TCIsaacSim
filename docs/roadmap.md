...
### Start here → `IG.1` · Isaac glue integrity

> **Split `strict_materials` into three flags** — material resolution, thermal-node coverage, patch coverage — and turn the patch-coverage guard back on by default. All six render scripts pass `strict_materials=False`.

`IG.1` is phase 0, size S, and unblocks 2 other step(s).

#### Then, in order — 107 open steps

| # | step | lane | phase | size | unblocks | waiting on |
|---|---|---|---|---|---|---|
| 1 | **`IG.1`** | IG | 0 | S | 2 | ready |
| 2 | **`RP.4`** | RP | 0 | M | 2 | ready |
| 3 | **`RP.7`** | RP | 0 | M | 2 | ready |
| 4 | **`IG.5`** | IG | 0 | S | 1 | ready |
| 5 | **`RP.6`** | RP | 0 | M | 1 | ready |
| 6 | **`IG.8`** | IG | 0 | S | — | ready |
| 7 | **`PT.4`** | PT | 0 | S | — | ready |
| 8 | **`RP.8`** | RP | 0 | S | — | ready |
| 9 | **`RP.9`** | RP | 0 | S | — | ready |
| 10 | **`RP.2`** | RP | 0 | M | — | ready |
| 11 | **`RP.5`** | RP | 0 | M | — | ready |
| 12 | **`PT.2`** | PT | A | M | 7 | ready |
| 13 | **`PT.1`** | PT | A | M | 4 | ready |
| 14 | **`PT.5`** | PT | A | M | 4 | `PT.2` |
| 15 | **`AT.1`** | AT | A | L | 4 | ready |
