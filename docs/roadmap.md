...
### Start here → `RP.9` · Repair

> The row-length and ledger parsers in `make check`. Step rows capped at 600 characters, ledger rows at 200.

`RP.9` is phase 0, size S, and unblocks 0 other step(s).
...
| 2 | **`RP.2`** | RP | 0 | M | — | ready |
| 3 | **`RP.5`** | RP | 0 | M | — | ready |
| 4 | **`PT.2`** | PT | A | M | 7 | ready |
| 5 | **`PT.1`** | PT | A | M | 4 | ready |
| 6 | **`PT.5`** | PT | A | M | 4 | `PT.2` |
| 7 | **`AT.1`** | AT | A | L | 4 | ready |
| 8 | **`GT.1`** | GT | A | M | 2 | ready |
| 9 | **`IG.13`** | IG | A | M | 2 | ready |
| 10 | **`SC.1`** | SC | A | M | 2 | ready |
| 11 | **`AT.2`** | AT | A | S | 1 | ready |
| 12 | **`SC.3`** | SC | A | M | 1 | ready |
| 13 | **`AT.3`** | AT | A | S | — | `AT.2` |
| 14 | **`AT.5`** | AT | A | S | — | ready |
| 15 | **`IG.6`** | IG | A | S | — | ready |
